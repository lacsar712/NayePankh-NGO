...
/**
 * 【ui 层】管理员通知日志 Tab（纯展示组件，localStorage 模拟收件箱）
 * @param {{
 *   notifications: Array,
 *   selected: object|null,
 *   onSelect: (notif: object) => void,
 *   onClear: () => void
 * }} props
 */
function NotificationsTab({ notifications, selected, onSelect, onClear }) {
  return (
                ...
                <div className="p-4 bg-slate-50 border-b border-slate-150 text-left">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-1">
                        <span className="font-semibold text-slate-400">To:</span> {selected.recipient}
                      </p>
                    </div>
