// UI component: overview tab — recent donations + volunteer submissions.
export default function OverviewPanel({ donations, volunteers }) {
  return (
            ...
            {donations.map((don) => (
              <div key={don.id} className="py-3 flex justify-between items-center text-sm">
                ...
                <div className="text-right">
                  ...
                  <span className="text-[10px] uppercase font-bold text-primary-500">
                    {don.frequency}
                  </span>
                </div>
              </div>
