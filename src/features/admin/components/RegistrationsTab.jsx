// Admin UI layer — Registrations tab (attendance + certificate actions)
import { memo } from 'react';
import { Award, Check, Trash2 } from 'lucide-react';

function RegistrationsTab({ registrations, onMarkAttended, onViewCertificate, onDelete }) {
  return (
