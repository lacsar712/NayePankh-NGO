...
/**
 * 【ui 层】志愿者审批 Tab（纯展示组件）
 * @param {{ volunteers: Array, onApprove: (id: string) => void, onReject: (id: string) => void }} props
 */
function VolunteersTab({ volunteers, onApprove, onReject }) {
  return (
...
export default memo(VolunteersTab);
