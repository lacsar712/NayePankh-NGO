...
export default function CertificateModal({
  ...
  return (
    <div
      ...
      className="fixed inset-0 bg-slate-950/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto no-print"
    >
      <div className="bg-white rounded-3xl p-6 sm:p-8 max-w-2xl w-full shadow-2xl relative border border-slate-200">
        ...
        <div
          className="bg-amber-50/20 border-8 border-double border-amber-600 p-8 sm:p-12 text-center rounded-2xl relative font-serif"
          style={{ backgroundColor: '#fffdf9' }}
        >
          <div className="absolute top-4 left-4 text-amber-600/60 text-xl">
            ✥
          </div>
          <div className="absolute top-4 right-4 text-amber-600/60 text-xl">
            ✥
          </div>
          <div className="absolute bottom-4 left-4 text-amber-600/60 text-xl">
            ✥
          </div>
          <div className="absolute bottom-4 right-4 text-amber-600/60 text-xl">
            ✥
          </div>
          ...
          <div className="space-y-6">
            <img
              src="/logo.png"
              className="h-16 w-16 mx-auto object-contain bg-white p-1.5 rounded-2xl border border-amber-100 shadow-sm"
              alt="NayePankh Logo"
            />
            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#132a13] uppercase tracking-widest font-display">
              Certificate of Participation
            </h2>
            <p className="text-slate-400 text-[10px] uppercase tracking-widest font-sans font-bold">
            ...
            <p className="text-slate-650 text-xs sm:text-sm max-w-md mx-auto leading-relaxed font-sans">
              for outstanding volunteer contributions and active participation
              in the event{' '}
              <strong className="text-slate-950">
                "{certificate.eventTitle}"
              </strong>{' '}
              on <strong className="text-slate-950">{certificate.date}</strong>,
              logging{' '}
              <strong className="text-slate-950">
            ...
            <div className="grid grid-cols-2 gap-4 pt-6 border-t border-amber-250/60 max-w-sm mx-auto font-sans">
              ...
              <div className="text-center">
                ...
                <p className="text-xs font-bold text-slate-850 mt-1 font-mono uppercase">
            ...
            <div className="grid grid-cols-2 gap-4 pt-6 max-w-sm mx-auto font-sans relative">
              ...
              <div className="text-center flex flex-col items-center relative min-h-[48px] justify-end">
                {certificate.signatureUrl || sigImage ? (
                  ...
                  <span className="font-serif italic text-xs text-slate-750 font-bold absolute bottom-5">
                    Prashant Shukla
                  </span>
                )}
                <div className="w-16 h-px bg-slate-300 my-1"></div>
                <p className="text-[8px] text-slate-400 font-sans uppercase font-bold">
                  Founder President
                </p>
              </div>
