// UI component: printable certificate modal overlay.
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-650 text-xs sm:text-sm max-w-md mx-auto leading-relaxed font-sans">
              for outstanding volunteer contributions and active participation in the event{' '}
              <strong className="text-slate-950">
                "{certificate.eventTitle}"
              </strong>{' '}
              on <strong className="text-slate-950">{certificate.date}</strong>, logging{' '}
              <strong className="text-slate-950">{certificate.hours} hours</strong> of
              community service.
            </p>
