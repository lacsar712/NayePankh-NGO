...
/**
 * 【ui 层】Overview KPI 卡片行（渲染于 Tab 导航之上，纯展示组件）
 * @param {{ totals: { donationsSum: number, volunteersCount: number, usersCount: number, eventsCount: number } }} props
 */
function OverviewKpiRow({ totals }) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
      <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-2xl font-black text-slate-900 mt-1">₹{totals.donationsSum.toLocaleString('en-IN')}</h3>
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-2xl font-black text-slate-900 mt-1">{totals.volunteersCount.toLocaleString()}</h3>
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-2xl font-black text-slate-900 mt-1">{totals.usersCount.toLocaleString()}</h3>
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-2xl font-black text-slate-900 mt-1">{totals.eventsCount}</h3>
...
export default memo(OverviewKpiRow);
