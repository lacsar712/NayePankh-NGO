// Admin UI layer — KPI summary row (overview header cards).
// Pure presentational: renders values from the memoized `stats` object produced
// by computeAdminStats; performs no aggregation of its own.
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
      <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-2xl font-black text-slate-900 mt-1">₹{stats.totalDonationSum.toLocaleString('en-IN')}</h3>
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-2xl font-black text-slate-900 mt-1">{stats.totalVolunteersCount.toLocaleString()}</h3>
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-2xl font-black text-slate-900 mt-1">{stats.totalUsersCount.toLocaleString()}</h3>
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center space-x-4">
        ...
        <div>
          ...
          <h3 className="text-2xl font-black text-slate-900 mt-1">{stats.totalEventsCount}</h3>
